...
# Export to PNG
ggsave("chase_art/everything/chase_ratchet_202103192133.png",
       device = "png", width = 10, height = 8, units = "in", dpi = 600)

# chase_ratchet_202103192150 ---------------------------------------------------
...
df=createTrajectory(9000000, 0, 0, 0, a, b, c, d, v)
...
# Export to PNG
ggsave("chase_art/everything/chase_ratchet_202103192150.png",
       device = "png", width = 10, height = 8, units = "in", dpi = 600)

# chase_ratchet_202103192333 ---------------------------------------------------
...
# Export to PNG
ggsave("chase_art/everything/chase_ratchet_202103192333.png",
       device = "png", width = 10, height = 8, units = "in", dpi = 600)